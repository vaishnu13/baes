...
export default function FloatingWhatsApp() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-lg shadow-black/30 flex items-center justify-center hover:bg-[#20bd5a] transition-colors"
